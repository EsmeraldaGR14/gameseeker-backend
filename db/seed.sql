...
INSERT INTO 
    game (title, genre, rating, description, platform, boxart, ESRB, subscription_service, released_year, developer, publisher, screenshots, play_time, completion_time)
VALUES 
    ('The Legend of Adventure', 'Action-Adventure', 8.5, 'Embark on an epic quest to save the kingdom from darkness.', 'PlayStation 5', 'legend_of_adventure.jpg', 'E10+', 'Xbox Game Pass', 2022, 'Quest Studios', 'Gamer Corp', 'screenshot1.jpg', 30, 40),
